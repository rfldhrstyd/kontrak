                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td style="text-align: center;"><a href="details.php?id=<?php echo $row['id_kontrak']; ?>" class="details"><i class='bx bx-file'></i></a>
                                    <a href="details.php?id=<?php echo $row['id_kontrak']; ?>" class="edit"><i class='bx bx-edit'></i></a>
